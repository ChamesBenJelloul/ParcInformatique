...
@section('content')
    ...
    <div class="container">
        ...
        <div align="center" class="form-group">
            @if($oldEquipement['nom']=="Unité Centrale")<img src="{{asset('img/Unité Centrale.png')}}" width="70" height="70">@endif
            @if($oldEquipement['nom']=="Ecran")<img src="{{asset('img/Ecran.png')}}" width="70" height="70">@endif
            @if($oldEquipement['nom']=="Imprimante")<img src="{{asset('img/Imprimante.png')}}" width="70" height="70">@endif
            @if($oldEquipement['nom']=="Scanner")<img src="{{asset('img/Scanner.png')}}" width="70" height="70">@endif
            @if($oldEquipement['nom']=="Ordinateur Portable")<img src="{{asset('img/Ordinateur Portable.png')}}" width="70" height="70">@endif
            @if($oldEquipement['nom']=="consommables")<img src="{{asset('img/consommables.png')}}" width="70" height="70">@endif
            @if($oldEquipement['nom']=="Switch")<img src="{{asset('img/Switch.png')}}" width="70" height="70">@endif
            @if($oldEquipement['nom']=="Routeur")<img src="{{asset('img/Routeur.png')}}" width="70" height="70">@endif
        </div>
        <table class="table">
